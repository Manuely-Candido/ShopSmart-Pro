...
function desconto(){
    ...
    if(isNaN(v1)  || isNaN(v2)) {
        ...
        resultado.innerHTML = ` 
            ...
            <li>O valor total com o desconto é <span>R$${v1 - desconto}</span> </li>
        `
    };
...
function juros(){
    ...
    if(isNaN(v1)  || isNaN(v2)) {
        ...
        resultado.innerHTML = `
            ...
            <li>O valor total com o acréscimo é R$<span>${v1 + acrescimo}</span> </li>
        `
    };
...
function comissao(){
    ...
    if(isNaN(v1)  || isNaN(v2)) {
        ...
        resultado.innerHTML = `
            <h2>Comissão</h2>        
            <li>A sua comissão de ${v2}% sobre uma venda de ${v1} </li>
